    ...
    <>
      ...
      >
        ...
        >
          ...
          <a
            href="#collections"
            className="label hidden md:block opacity-70 hover:opacity-100 transition-opacity duration-200"
          >
            Colecoes
          </a>
          <a
        ...
        <a
          ...
          className="flex flex-col items-center justify-self-center gap-[3px] no-underline"
        >
          <span
            className="font-serif font-bold uppercase leading-none tracking-[0.18em]"
