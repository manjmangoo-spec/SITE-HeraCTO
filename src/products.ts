...
export const PRODUCTS: Product[] = [
  {
    ...
    sizes: ['P', 'M', 'G', 'GG'],
    stock: 9,
    image: '/assets/images/products/produto-camiseta-lacoste.png',
    images: [
      '/assets/images/products/produto-camiseta-lacoste.png',
      '/assets/images/products/produto-camiseta-lacoste.png',
    ],
  ...
  },
  {
    ...
    sizes: ['P', 'M', 'G'],
    stock: 5,
    image: '/assets/images/products/produto-kit-boss.png',
    images: [
      '/assets/images/products/produto-kit-boss.png',
      '/assets/images/products/produto-kit-boss.png',
    ],
  ...
  },
  {
    ...
    stock: 6,
    image: '/assets/images/products/produto-camiseta-lacoste.png',
    images: ['/assets/images/products/produto-camiseta-lacoste.png'],
  ...
  },
  {
    ...
    stock: 3,
    image: '/assets/images/products/produto-kit-boss.png',
    images: ['/assets/images/products/produto-kit-boss.png'],
